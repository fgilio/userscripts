...
|---|---|---|
| `chatgpt-scheduled-tasks.user.js` | 2026-08-19 | ChatGPT added a native **Scheduled** sidebar item; the script's mount point also no longer exists, so it threw on every load |
