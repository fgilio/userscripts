...
function buildCloudButton(label, href, onClick) {
    ...
    function addCloudLink() {
        ...
        if (document.getElementById('nightwatch-link')) return;
    ...
    function addNightwatchLink() {
        ...
        if (document.getElementById('cloud-link')) return;
    ...
    function init() {
        ...
        try {
            ...
            console.warn('[CloudNightwatchLinker]', e);
        }
    }
